...
func GetAvailableVersions(service string, yamlConfig *config.YamlConfig) []string {
	...
	case App:
		...
		case framework.BitrixNuxt, framework.Laravel, framework.Symfony, framework.Yii2, framework.Yii3, framework.Vanilla:
	...
	case Mysql:
		switch yamlConfig.FrameworkName {
		case framework.Laravel, framework.Symfony, framework.Yii2, framework.Yii3, framework.Vanilla:
